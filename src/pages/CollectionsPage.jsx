    ...
    return (
        <div className="space-y-6 max-w-7xl mx-auto pb-10">
            ...
            <div className="bg-white border border-zinc-200 rounded-2xl p-5 sm:p-6 shadow-sm flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    ...
                    <p className="text-xs text-zinc-500 font-mono mt-1">
                        Gestión de créditos, saldos pendientes y recuperación de cartera comercial.
                    </p>
                </div>
                <div className="flex items-center gap-3">
                    {isCashOpen && activeSession ? (
                        <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-zinc-100 border border-zinc-300 rounded-xl text-xs text-zinc-900 font-mono">
                            <span className="w-2 h-2 rounded-full bg-zinc-900" />
                            <span className="font-bold">Caja #{activeSession.id} Abierta</span>
                            <span className="text-zinc-600 font-medium hidden sm:inline">
                                • {activeSession.openingEmployeeName || `ID ${activeSession.openingEmployeeId}`}
                            </span>
                        </div>
                    ) : (
                        <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-zinc-100 border border-zinc-200 rounded-xl text-xs text-zinc-600 font-mono">
                            <span className="w-2 h-2 rounded-full bg-zinc-400" />
                            <span className="font-bold">Caja Cerrada</span>
                            <button
                                type="button"
                                onClick={() => navigate("/cash-sessions/open")}
                                className="underline font-bold text-zinc-900 hover:text-black ml-1 cursor-pointer"
                            >
                                Abrir
                            </button>
                        </div>
                    ...
                    <button
                        ...
                        className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#09090b] hover:bg-zinc-800 text-white text-xs font-bold rounded-xl shadow transition-all cursor-pointer uppercase font-mono tracking-wider"
                    >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                ...
                <div className="bg-white rounded-2xl p-5 shadow-sm border border-zinc-200 flex items-center justify-between">
                    <div>
                    ...
                    <div className="w-10 h-10 rounded-xl bg-zinc-100 border border-zinc-200 flex items-center justify-center text-zinc-900 flex-shrink-0">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                ...
                <div className="lg:col-span-8 bg-white rounded-2xl p-5 shadow-sm border border-zinc-200 space-y-4">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 pb-3 border-b border-zinc-100">
                        <div className="flex items-center gap-2">
                            <div className="w-7 h-7 rounded-lg bg-zinc-100 text-zinc-900 flex items-center justify-center font-mono font-bold text-xs">
                                #
                            </div>
                        ...
                        <div className="relative w-full sm:w-64">
                            ...
                            <input
                                ...
                                className="w-full pl-9 pr-3 py-1.5 bg-zinc-50 border border-zinc-200 rounded-xl text-xs font-medium text-zinc-900 placeholder-zinc-400 focus:bg-white focus:outline-none focus:border-zinc-900 transition-all font-sans"
                            />
                        </div>
                    </div>
                    ...
                    <div className="overflow-x-auto">
                        {isLoading ? (
                            <div className="flex flex-col items-center justify-center py-16 text-zinc-400">
                                ...
                                <span className="text-xs font-mono uppercase tracking-wider">Cargando deudores...</span>
                            </div>
                        ) : filteredDebtors.length === 0 ? (
                            <div className="py-16 text-center">
                                <div className="w-12 h-12 rounded-full bg-zinc-100 text-zinc-700 flex items-center justify-center mx-auto mb-3">
                                    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
                                    </svg>
                                </div>
                                <h3 className="text-xs font-bold text-zinc-900">Sin cartera vencida</h3>
                            ...
                            <table className="w-full text-left border-collapse">
                                <thead>
                                    <tr className="border-b border-zinc-200 bg-zinc-100/70 text-[10px] font-mono font-bold text-zinc-600 uppercase tracking-wider">
                                ...
                                <tbody className="divide-y divide-zinc-100 text-xs">
                                    {filteredDebtors.map((debtor) => {
                                        ...
                                        return (
                                            <tr key={debtor.id} className="hover:bg-zinc-50/70 transition-colors">
                                                {/* CLIENTE */}
                                                <td className="py-3 px-4">
                                                    <div className="flex items-center gap-3">
                                                        <div className="w-8 h-8 rounded-lg bg-zinc-900 text-white font-mono font-bold text-xs flex items-center justify-center flex-shrink-0">
                                                            {initials}
                                                        </div>
                                                        <div>
                                                            ...
                                                            <span className="text-[10px] font-mono text-zinc-400 block mt-0.5 uppercase tracking-wider">
                                                                PLAZO: {debtor.creditDays || 30} DÍAS
                                                            </span>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td className="py-3 px-4">
                                                    <div>
                                                        <span className="inline-flex items-center px-2 py-0.5 rounded text-[10px] font-mono font-bold bg-zinc-100 text-zinc-800 border border-zinc-200">
                                                ...
                                                <td className="py-3 px-4 text-right">
                                                    <button
                                                        ...
                                                        className="px-3 py-1 bg-[#09090b] hover:bg-zinc-800 text-white font-mono font-bold text-xs rounded-xl transition-all cursor-pointer"
                                                    >
                                                        Gestionar Pago
                                                    </button>
                                                </td>
                ...
                <div className="lg:col-span-4 space-y-5">
                    ...
                    <div className="bg-white rounded-2xl p-5 shadow-sm border border-zinc-200 space-y-4">
                        ...
                        {(!stats.recentPayments || stats.recentPayments.length === 0) ? (
                            <div className="py-12 text-center text-xs text-zinc-400 font-mono italic">
                                Sin pagos recientes.
                            </div>
                        ) : (
                            <div className="space-y-2.5">
                                {stats.recentPayments.slice(0, 5).map((pay) => (
                                    <div key={pay.id} className="flex items-center justify-between p-2.5 bg-zinc-50 rounded-xl border border-zinc-200">
                                        <div className="min-w-0 pr-2">
                                            <span className="font-bold text-zinc-900 text-xs block truncate">
                                        ...
                                        <div className="text-right flex-shrink-0">
                                            <span className="font-bold font-mono text-zinc-900 text-xs block">
                        ...
                        <div className="pt-2 text-center border-t border-zinc-100">
                            <Link
                                to="/sales"
                                className="text-xs font-mono font-bold text-zinc-900 hover:underline transition-colors"
                            >
                    ...
                    {/* Consejo de Cartera */}
                    <div className="bg-[#09090b] text-white p-5 rounded-2xl border border-zinc-800 shadow-sm">
                        <h4 className="text-xs font-bold uppercase tracking-wider mb-2 flex items-center gap-1.5 font-mono">
                        ...
                        <p className="text-xs text-zinc-400 leading-relaxed font-sans">
                            Realiza un seguimiento a los clientes que superen el 80% de su límite de crédito para evitar riesgos de impago y morosidad comercial.
                        </p>
                    </div>
                </div>
