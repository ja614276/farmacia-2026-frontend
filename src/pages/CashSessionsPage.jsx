    ...
    return (
        <div className="max-w-7xl mx-auto px-4 py-6 sm:px-6 space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    <div className="text-[10px] font-bold text-zinc-400 uppercase tracking-wider mb-1">
                        DASHBOARD / CAJA Y FINANZAS / CONTROL DE TURNOS
                    </div>
                    <h1 className="text-2xl font-black text-zinc-900 tracking-tight">
                        Gestión de Turnos de Caja
                    </h1>
                    <p className="text-xs font-medium text-zinc-500 mt-0.5">
                        Supervisión de sesiones, control de apertura/cierre y arqueos en tiempo real.
                    </p>
                </div>
                ...
                <div>
                    {hasActiveSession ? (
                        ...
                        <button
                            ...
                            className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#09090b] hover:bg-[#27272a] text-white font-bold text-xs rounded-xl shadow-sm transition-all cursor-pointer"
                        >
                            <span>+ Nueva Apertura</span>
                        </button>
                    )}
            ...
            {isLoading ? (
                ...
                <div className="bg-white border border-zinc-200 rounded-2xl p-5 sm:p-6 flex flex-col md:flex-row md:items-center justify-between gap-5 shadow-sm">
                    <div className="flex items-center gap-4">
                        <div className="w-12 h-12 rounded-xl bg-[#09090b] text-white flex items-center justify-center shadow-sm flex-shrink-0">
                        ...
                        <div>
                            <div className="flex items-center gap-2 mb-1">
                                <span className="bg-[#09090b] text-white font-bold text-[10px] px-2.5 py-0.5 rounded uppercase tracking-wider">
                                    SESIÓN EN CURSO
                                </span>
                    ...
                    <div className="flex items-center justify-between md:justify-end gap-6 pt-3 md:pt-0 border-t md:border-t-0 border-zinc-200">
                        ...
                        {isSessionOwner(activeSession) ? (
                            ...
                            <button
                                ...
                                className="inline-flex items-center gap-2 px-4 py-2.5 bg-zinc-100 hover:bg-zinc-200 text-zinc-700 font-bold text-xs rounded-xl border border-zinc-200 transition-all cursor-pointer"
                ...
                /* ESTADO 2: CAJA CERRADA */
                <div className="bg-zinc-50 border border-zinc-200 rounded-2xl p-5 sm:p-6 flex items-center gap-3.5 shadow-sm">
                    <div className="w-8 h-8 rounded-full bg-[#09090b] text-white flex items-center justify-center font-bold text-xs flex-shrink-0">
                        i
                    </div>
                    <div>
                                ...
                                {paginatedSessions.map((s) => {
                                    ...
                                    return (
                                        <tr key={s.id} className="hover:bg-slate-50/60 transition-colors">
                                            ...
                                            <td className="py-3.5 px-5">
                                                <div className="flex items-center gap-2">
                                                    <div className="w-7 h-7 rounded bg-[#09090b] text-white flex items-center justify-center font-bold text-xs flex-shrink-0">
                                            ...
                                            <td className="py-3.5 px-5 text-center">
                                                {isOpen ? (
                                                    <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded text-[10px] font-bold bg-[#09090b] text-white tracking-wider">
                                                        ABIERTA
                                                    </span>
                                                ) : (
                                                    <span className="inline-flex items-center px-2.5 py-0.5 rounded text-[10px] font-bold bg-zinc-100 text-zinc-700 border border-zinc-200">
                                                        CERRADA
                                                    </span>
                                                )}
                                            </td>
                    ...
                    <div className="p-4 border-t border-slate-100 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-500">
                        ...
                        {totalPages > 1 && (
                            <div className="flex items-center gap-1">
                                ...
                                <span className="w-8 h-8 rounded-lg flex items-center justify-center bg-[#09090b] text-white font-bold text-xs">
                                    {currentPage}
                                </span>
                                <button
                                    type="button"
